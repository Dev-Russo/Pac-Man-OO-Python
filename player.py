...
class Player(Character):
    ...
    def reset_player_and_ghosts(self, blink, pink, ink, clyde):
    ...
    def handle_ghost_collision(self, ghost):
        ghost.setDead(True)
        ghost.setEaten(True)
